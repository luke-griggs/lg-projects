  ...
  return (
    ...
    >
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        ...
        <Image
          src="/../public/assets/SITE_LOGO-removebg-preview.png"
          alt="/"
          width="125"
          height="50"
        />
        ...
        >
          <div>
            <div className="flex w-full items-center justify-between">
              ...
              <div
                onClick={handleNav}
                className="rounded-full shadow-lg shadow-gray-400 p-3 first-letter:cursor-pointer"
              >
                <AiOutlineClose />
              </div>
            </div>
            <div
              className="border-b border-gray-300 my-0"
              style={{ height: "40px" }}
            >
              <p
                className="w-[85%] md:w-[90%] py-3"
